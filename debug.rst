...
.. note:: Кстати, эту конструкцию можно использовать не только для отладки а например для того чтобы сделать **общий для всех устройств сервер а Python**, для исполнения онлайн, совместной работы, API к совместному хранилищу и другие применения 
